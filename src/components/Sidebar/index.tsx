    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              fill=""
              d="M49.533 127.723H11.631V53.604c0-7.777 4.453-14.677 11.457-17.94V9.469h16.986v26.194c7.005 3.266 11.458 10.165 11.458 17.94v5.652h-4v-5.652c0-6.572-3.996-12.363-10.179-14.754l-1.279-.494V13.469h-8.986v24.888l-1.279.494c-6.183 2.388-10.178 8.179-10.178 14.753v70.119h33.901v4z"
            />
            <path
              fill=""
              d="M21.714 19.718h19.734v4H21.714zM40.231 110.494H20.733V56.012h19.498v4H24.733v46.482h15.498z"
            />
            <g>
              <path
                fill=""
                d="M101.59 80.68 90.064 63.575H56.91v-4h34.219l1.658.883 12.119 17.987z"
              />
              <path
                fill=""
                d="M103.057 82.479H68.83v-4h26.941l-12.058-7.162 2.043-3.439 18.322 10.881z"
              />
              <path
                fill=""
                d="M104.879 127.723H77.205V78.479h27.674v49.244zm-23.674-4h19.674V82.479H81.205v41.244z"
              />
              <path
                fill=""
                d="M81.205 127.723h-38.22V78.479h38.22v49.244zm-34.22-4h30.22V82.479h-30.22v41.244zM93.129 63.575H54.91V50.127h38.219v13.448zm-34.219-4h30.219v-5.448H58.91v5.448z"
              />
              <path
                fill="#282D33"
                d="m80.428 80.672-3.297-2.266 10.197-14.831H57.962L46.211 80.672l-3.297-2.266 12.347-17.964 1.649-.867h34.219l1.648 3.133z"
              />
            </g>
            <g>
              <path
                fill=""
                d="M61.694 112.16c-5.419 0-9.829-4.388-9.829-9.781s4.409-9.781 9.829-9.781c5.421 0 9.829 4.388 9.829 9.781s-4.408 9.781-9.829 9.781zm0-15.562c-3.214 0-5.829 2.594-5.829 5.781s2.615 5.781 5.829 5.781 5.829-2.594 5.829-5.781-2.615-5.781-5.829-5.781z"
              />
            </g>
            <g>
              <path fill="" d="M116.369 128h-4V27.75H45.64v-4h70.729z" />
              <path
                fill=""
                d="M60.967 36.742h-4V19.635C56.967 8.808 65.822 0 76.709 0h6.898c10.887 0 19.742 8.808 19.742 19.635v17.106h-4V19.635C99.35 11.014 92.289 4 83.607 4h-6.898c-8.68 0-15.742 7.014-15.742 15.635v17.107z"
              />
            </g>
          </svg>
        ),
...

      {
        icon: (
          ...
          >
            <path
              d="m86.864 59.496-7-12A1 1 0 0 0 79 47h-9V10a5.006 5.006 0 0 0-5-5H23a5.006 5.006 0 0 0-5 5v14a1 1 0 0 0 1 1h7v22H9a1 1 0 0 0-.864.496l-7 12A1 1 0 0 0 2 61h6v21a1 1 0 0 0 1 1h70a1 1 0 0 0 1-1V61h6a1 1 0 0 0 .864-1.504zM20 23V10a3 3 0 0 1 6 0v13zm8 1V10a5.263 5.263 0 0 0-1.002-3H65a3.003 3.003 0 0 1 3 3v37H28zM9.574 49H29.26l-5.833 10H3.74zM10 61h14a1 1 0 0 0 .864-.496L30 51.699V81H10zm68 20H32V51.699l5.136 8.805A1 1 0 0 0 38 61h40zM38.574 59l-5.833-10h45.685l5.833 10z"
              fill=""
            />
            <path
              d="m37.186 28.21 1.367.684a1.001 1.001 0 0 0 .894 0l1.367-.683A12.928 12.928 0 0 0 48 16.584V15a1 1 0 0 0-.47-.848l-8-5a.998.998 0 0 0-1.06 0l-8 5A1 1 0 0 0 30 15v1.584a12.927 12.927 0 0 0 7.186 11.627zM32 15.556l7-4.375 7 4.375v1.029a10.939 10.939 0 0 1-6.08 9.838l-.92.46-.92-.46A10.939 10.939 0 0 1 32 16.584z"
              fill=""
            />
            <path
              d="M38 22a.997.997 0 0 0 .707-.293l4-4a1 1 0 0 0-1.414-1.414L38 19.586l-1.293-1.293a1 1 0 0 0-1.414 1.414l2 2A.997.997 0 0 0 38 22zM51 14h14a1 1 0 0 0 0-2H51a1 1 0 0 0 0 2zM51 21h14a1 1 0 0 0 0-2H51a1 1 0 0 0 0 2zM65 26H48a1 1 0 0 0 0 2h17a1 1 0 0 0 0-2zM31 35h34a1 1 0 0 0 0-2H31a1 1 0 0 0 0 2zM65 42a1 1 0 0 0 0-2H31a1 1 0 0 0 0 2zM57 75h18a1 1 0 0 0 0-2H57a1 1 0 0 0 0 2zM75 77h-8a1 1 0 0 0 0 2h8a1 1 0 0 0 0-2z"
              fill=""
            />
          </svg>
        ),
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 2a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm0 2c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm-7 14c0-3.866 3.134-7 7-7s7 3.134 7 7c0 .552-.448 1-1 1H6c-.552 0-1-.448-1-1zm2.07-.07C7.56 15.345 9.62 14 12 14s4.44 1.345 4.93 3.93H6.07z"
              fill="currentColor"
            />
          </svg>
        ),
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 2C8.686 2 6 4.686 6 8c0 4.39 5.4 11.4 5.646 11.733a1 1 0 0 0 1.708 0C12.6 19.4 18 12.39 18 8c0-3.314-2.686-6-6-6zm0 15.67C10.77 15.317 8 10.936 8 8c0-2.205 1.795-4 4-4s4 1.795 4 4c0 2.936-2.77 7.317-4 9.67zM12 10c-1.105 0-2-.896-2-2s.895-2 2-2 2 .896 2 2-.895 2-2 2z"
              fill="currentColor"
            />
          </svg>
        ),
        label: "Avaliable Region",
        route: "/region",
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Dashboard", route: "/inventory" },
          { label: "Purchase Orders", route: "/purchase-orders" },
          { label: "Stock Adjustment", route: "/inventory/adjustment-with-variants" },
        ],
      },
      {
        icon: (
          <svg
            ...
            strokeWidth="0.8"
          >
            <path d="M32.317 15.679a.728.728 0 0 0-1.028 0L18.6 28.365a.728.728 0 0 0 0 1.029.727.727 0 0 0 1.028 0l12.689-12.686a.728.728 0 0 0 0-1.029zM26.291 26.3a3.655 3.655 0 1 0 5.169 0 3.658 3.658 0 0 0-5.169 0zm4.141 4.138a2.252 2.252 0 0 1-3.112 0 2.2 2.2 0 1 1 3.112 0zM21.7 21.707a3.661 3.661 0 0 0 0-5.17 3.741 3.741 0 0 0-5.168 0 3.655 3.655 0 0 0 5.168 5.17zm-4.14-4.141a2.2 2.2 0 1 1 0 3.111 2.185 2.185 0 0 1 .001-3.111z" />
            <path d="m47.822 20.908-3.441-4.041.173-5.3a.729.729 0 0 0-.433-.689L39.267 8.73l-2.146-4.854a.707.707 0 0 0-.688-.434l-5.3.172L27.091.175a.726.726 0 0 0-.809-.092l-4.7 2.455-5.137-1.348a.732.732 0 0 0-.768.27l-3.172 4.254L7.3 6.726a.729.729 0 0 0-.575.576l-1.017 5.209-4.252 3.172a.728.728 0 0 0-.269.768l1.347 5.133-2.455 4.7v.01l-.011.016a.685.685 0 0 0-.042.145c-.005.02-.014.037-.017.057a.693.693 0 0 0 0 .182v.041a.739.739 0 0 0 .062.2.159.159 0 0 0 .007.02.726.726 0 0 0 .134.186L20.86 47.789a.722.722 0 0 0 .514.215.73.73 0 0 0 .311-.07c.006 0 .009-.008.015-.01h.011l4.7-2.455 5.133 1.348a.723.723 0 0 0 .768-.27l3.172-4.254 5.216-1.016a.726.726 0 0 0 .575-.574l1.012-5.209 4.254-3.174a.729.729 0 0 0 .27-.768l-1.351-5.131 2.455-4.7a.728.728 0 0 0-.093-.813zM19.971 39.927a.708.708 0 0 0-.015.234l.5 5.164L8.247 33.118l-5.576-5.576 5.164.5a.661.661 0 0 0 .235-.016l6.356-1.479 1.358 5.148a.734.734 0 0 0 .518.518l5.148 1.357zm2.534-7.582-5.422-1.432-1.43-5.422a.732.732 0 0 0-.868-.523l-5 1.164A14.419 14.419 0 1 1 21.87 38.184l1.158-4.973a.726.726 0 0 0-.523-.866zM44.038 26a.735.735 0 0 0-.059.521l1.3 4.93-4.087 3.047a.725.725 0 0 0-.279.443l-.972 5-5 .973a.732.732 0 0 0-.444.279l-3.047 4.086-4.93-1.3a.719.719 0 0 0-.521.059l-4 2.086-.578-5.988.12-.516a15.514 15.514 0 0 0 2.46.221A15.856 15.856 0 1 0 8.347 26.469l-.492.113L1.866 26l2.086-4a.738.738 0 0 0 .059-.521l-1.294-4.93L6.8 13.508a.721.721 0 0 0 .279-.443l.974-5 5-.973a.72.72 0 0 0 .444-.279l3.046-4.086 4.93 1.3A.731.731 0 0 0 22 3.959L26.519 1.6 30.4 4.905a.7.7 0 0 0 .495.174l5.094-.164 2.063 4.66a.717.717 0 0 0 .37.371l4.662 2.063-.167 5.091a.726.726 0 0 0 .174.5l3.309 3.878z" />
          </svg>
        ),
        label: "Discount",
        route: "/discounts",
