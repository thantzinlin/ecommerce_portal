...
const ProductForm: React.FC<ProductFormProps> = ({ id }) => {
  ...
  const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
        ...
        fileArray.map(file => {
          return new Promise<string>((resolve, reject) => {
            ...
            reader.onload = () => {
              ...
              resolve(result?.trim() || ''); // Make sure it's a string
            };
      ...
      const validImages = newImages.filter(img => img && img.startsWith('data:image/'));
  
      setProduct(prev => ({
        ...prev,
        images: prev.images[0] === '' 
          ? [...prev.images.slice(1), ...validImages] // Remove the first empty index and add valid images
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const transformedVariants = product.variants.map(variant => ({
        ...
        weight: variant.attributeValues['Weight'] || '',
        sku: generateSKU(product.name, variant.attributeValues, product.categoryId),
  ...
  return (
    <div className="rounded-lg  p-6 shadow-md them-bg ">
      ...
      {loading ? (
        ...
        <div className="mx-auto max-w-4xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-6  rounded-xl p-6 border  them-bg ">
              ...
              <div className="space-y-4">
                ...
                {/* Base Price */}
                <div className="flex items-center gap-4">
                  <label className="w-1/4 label">Base Price <span className="text-red-500">*</span></label>
                  <div className="w-3/4 relative">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const value = val === '' ? '' : Math.max(0, Number(val));
                        setProduct({ ...product, price: value.toString() });
                      }}
                ...
                {/* Category */}
                <div className="flex items-center gap-4">
                  <label className="w-1/4 label">Category <span className="text-red-500">*</span></label>
                  <div className="w-3/4">
                    <select
                      name="categoryId"
                ...
                {/* Stock Quantity */}
                <div className="flex items-center gap-4">
                  <label className="w-1/4 label">Stock Quantity <span className="text-red-500">*</span></label>
                  <div className="w-3/4">
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => {
                        ...
                        setProduct({ ...product, stockQuantity: value.toString() });
                      }}
                      onKeyDown={preventNegativeInput}
                      required
                      className={`w-full rounded-lg border ${
                ...
                <div className="flex items-start gap-4">
                  <label className="w-1/4 label pt-2">Upload Images</label>
            ...
            {/* Product Attributes */}
            <div className="space-y-6  rounded-xl p-6 shadow-sm border border-gray-100 mt-6">
              <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                <div>
                  <h3 className="text-h3">Product Attributes</h3>
                  <p className="text-p mt-1">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                  <div className="space-y-2">
                    <div className="mb-2"><h4 className="text-h5">Quick Guide:</h4></div>
                    <ul className="list-disc list-inside space-y-1">
                      <li className="text-p">For sizes: enter "Size" as name and "S,M,L" as values</li>
                      <li className="text-p">For weights: enter "Weight" as name and "100g,250g,500g" as values</li>
                    </ul>
                  </div>
                </div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="relative">
                              <input
                                ...
                                onKeyDown={preventNegativeInput}
                                className="w-full rounded-lg border border-gray-300 pl-8 pr-3 py-1 text-right focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                              />
                            </div>
                          </td>
